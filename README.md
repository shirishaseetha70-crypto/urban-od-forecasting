...
This project demonstrates the application of Spatial-Temporal Graph Attention Networks (ST-GAT) for predicting Origin-Destination flows from mobile signaling data. By combining spatial relationships between zones with temporal travel behavior, the model provides reliable mobility forecasts that can support transportation planning and smart city initiatives. The framework offers a scalable foundation for future research and real-world deployment in intelligent transportation systems.
---
